...
$accionForm = $esEdicion
    ? 'proveedores.php?accion=contacto_actualizar&id=' . urlencode((string) $contacto['id_contacto'])
    : 'proveedores.php?accion=contacto_crear';
...
<div class="form-section">
    ...
    <?php else: ?>
        <div class="alert-message error">
            <p><i class="bi bi-exclamation-triangle"></i> No se encontro el contacto. <a href="proveedores.php?accion=contactos">Volver al listado</a></p>
        </div>
    <?php endif; ?>
</div>
